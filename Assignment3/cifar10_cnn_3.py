...
quesNo = 3  # to mark the question number, for data saving
saveDir    = "./Result/"
...
model = loadmodel(saveDir+'%s_cifar10_model' %(str(quesNo-1)))
print('%s_loaded_model' %(str(quesNo)))
model.summary()
t1 = float(time.clock())
...
print('%s_saved_model' %(str(quesNo)))
model.summary()
t1 = float(time.clock())
