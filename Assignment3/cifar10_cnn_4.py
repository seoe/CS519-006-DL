...
quesNo = 4.11  # to mark the question number, for data saving
...
nb_classes = 10
nb_epoch = 80
data_augmentation = False  # true for 4.5
...
model = Sequential()
# model.add(AveragePooling2D(pool_size=(2,2), input_shape=(img_channels, img_rows, img_cols)))    # delete for 4.8
# model.add(Convolution2D(32, 3, 3, border_mode='same'))   # delete for 4.4
model.add(Convolution2D(32, 3, 3, border_mode='same',input_shape=(img_channels, img_rows, img_cols)))  # add for 4.8 
...
model.add(Flatten())
model.add(Dense(512))   # delete for 4.4
# model.add(Activation('relu'))  # delete for 4.3
# model.add(BatchNormalization())
model.add(Activation('sigmoid'))   # add for 4.3
model.add(Dropout(0.5)) # add for 4.2
model.add(Dense(256))     # add for 4.1
# model.add(Activation('relu')) # add for 4.1 delete for 4.3
# model.add(BatchNormalization())
model.add(Activation('sigmoid'))   # add for 4.3
model.add(Dropout(0.5)) # add for 4.2
